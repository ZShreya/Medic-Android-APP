package com.example.babun.ui.category;
...
import com.example.babun.adapters.NavCatagoryAdapter;
import com.example.babun.adapters.PopularAdapters;
import com.example.babun.databinding.FragmentCategoryBinding;
import com.example.babun.models.NavCatagoryModel;
...
public class CategoryFragment extends Fragment {
    ...
    List<NavCatagoryModel> catagoryModelList;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        navCatagoryAdapter = new NavCatagoryAdapter(getActivity(),catagoryModelList);
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                catagoryModelList.add(navCatagoryModel);
